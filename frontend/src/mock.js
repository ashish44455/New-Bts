...
export const TRUST = {
  ...
  visitedPeethas: [
    {
      id: "peetha-shankari",
      enName: "Shankari Devi Temple",
      enLocation: "Sri Lanka",
      teName: "శంకరీ దేవి ఆలయం",
      teLocation: "శ్రీలంక",
    },
    {
      id: "peetha-mahalakshmi",
      enName: "Mahalakshmi Temple",
      enLocation: "Kolhapur",
      teName: "మహాలక్ష్మి ఆలయం",
      teLocation: "కొల్హాపూర్",
    },
    {
      id: "peetha-chamundeshwari",
      enName: "Chamundeshwari Temple",
      enLocation: "Mysuru",
      teName: "చాముండేశ్వరి ఆలయం",
      teLocation: "మైసూరు",
    },
    {
      id: "peetha-jwalamukhi",
      enName: "Jwalamukhi Temple",
      enLocation: "Himachal Pradesh",
      teName: "జ్వాలాముఖి ఆలయం",
      teLocation: "హిమాచల్ ప్రదేశ్",
    },
    {
      id: "peetha-mahakaleswar",
      enName: "Mahakaleswar Temple",
      enLocation: "Ujjain",
      teName: "మహాకాళేశ్వర్ ఆలయం",
      teLocation: "ఉజ్జయినీ",
    },
    {
      id: "peetha-vishalakshi",
      enName: "Vishalakshi Temple",
      enLocation: "Varanasi",
      teName: "విశాలాక్షి ఆలయం",
      teLocation: "వారణాసి",
    },
    {
      id: "peetha-kamakhya",
      enName: "Kamakhya Temple",
      enLocation: "Guwahati",
      teName: "కామాఖ్య ఆలయం",
      teLocation: "గువాహటి",
    },
